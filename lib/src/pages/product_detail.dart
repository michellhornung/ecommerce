...
class _ProductDetailPageState extends State<ProductDetailPage>
              ...
              children: <Widget>[
                ...
                Container(
                  child: Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      TitleText(text: "BECKS", fontSize: 25),
                      Column(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Row(
          ...
          children: <Widget>[
            _sizeWidget("110ml"),
            _sizeWidget("330ml", isSelected: true),
            _sizeWidget("360ml"),
            _sizeWidget("600ml"),
          ],
        )
  ...
  Widget _availableColor() {
    return Column(
      ...
      children: <Widget>[
        TitleText(
          text: "Color to indicate anything you want",
          fontSize: 14,
        ),
        SizedBox(height: 20),
        Row(
