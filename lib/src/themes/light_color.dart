...
class LightColor {
  ...
  static const Color subTitleTextColor = const Color(0xff5a3f11);

  static const Color skyBlue = Color(0xff2890c8);
  static const Color lightBlue = Color(0xff5c3dff);
  

  static const Color orange = Color(0xffef962d);
  static const Color red = Color(0xff9c5518);
  ...
  static const Color iconColor = Color(0xff5a3f11);
